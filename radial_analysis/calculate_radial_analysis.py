    ...
    for hdf5_file in tqdm(expt_dict):
        ...
        for i in range(N_cells_per_expt):
            try:
                ...
                cell_ID = '{}_{}_ID:{}_t:{}'.format(expt,position,target_cell.ID,focal_time)
        ...
        for j, element in enumerate(row):
            ...
            if P_div > P_div_control:
                ...
                if measure1 > measure2:
                    ...
                    sig_dif_array[i,j] = 0
            elif P_div == P_div_control == 0: ### if P_div is zero then that is bc there arent enough events counted and it is not statistically relevant
                sig_dif_array[i,j] = 0
